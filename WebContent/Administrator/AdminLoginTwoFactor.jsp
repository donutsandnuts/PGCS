...
<table class='center'>
<tr><td>2FA Code:</td><td><input type="text" name="otp" size=50 required autofocus></td></tr>
<tr><td>&nbsp;</td><td><input name="id" size=50 type="text"  value="<%out.println(id);%>" readonly/> </td></tr>

<tr><td>&nbsp;</td><td><input name="abc" size=50 type="hidden"  value="blankValue>" readonly/> </td></tr>
